"""
Utilities for interpreting static from Stylers for formatting non-HTML outputs.
"""
...
def _border_expander(side: str = "") -> Callable:
    ...
    def expand(self, prop, value: str) -> Generator[tuple[str, str], None, None]:
        ...
        ----------
            prop : str
                static property name passed to styler
            value : str
        ...
        # TODO: Can we use current color as initial value to comply with static standards?
        border_declarations = {
        ...
        # Per static, "border" will reset previous "border-*" definitions
...
class CSSResolver:
    """
    A callable for parsing and resolving static to atomic properties.
    """
    ...
    def __call__(
        ...
        declarations_str : str | Iterable[tuple[str, str]]
            A static string or set of static declaration tuples
