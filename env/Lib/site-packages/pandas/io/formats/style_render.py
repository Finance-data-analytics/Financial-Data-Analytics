...
class StylerRenderer:
    ...
    def format(
        ...
        .. warning::
           ...
           However, it is possible to use the `number-format` pseudo static attribute
        ...
        Pandas defines a `number-format` pseudo static attribute instead of the `.format`
        method to create `to_excel` permissible formatting. Note that semi-colons are
        static protected characters but used as separators in Excel's format string.
...
def format_table_styles(styles: CSSStyles) -> CSSStyles:
    """
    looks for multiple static selectors and separates them:
...
def maybe_convert_css_to_tuples(style: CSSProperties) -> CSSList:
    ...
    if isinstance(style, str):
        ...
        try:
            ...
            raise ValueError(
                "Styles supplied as string must follow static rule formats, "
...
class Tooltips:
    ...
    css_name: str, default "pd-t"
        Name of the static class that controls visualisation of tooltips.
    css_props: list-like, default; see Notes
        List of (attr, value) tuples defining properties of the static class.
    ...
    def _class_styles(self):
        """
        Combine the ``_Tooltips`` static class name and static properties to the format
    ...
    def _pseudo_css(self, uuid: str, name: str, row: int, col: int, text: str):
        ...
        empty string) must create two pseudo static entries for the specific
    ...
    def _translate(self, styler: StylerRenderer, d: dict):
        ...
        - Add ``<span>`` HTML element to each data cells ``display_value``. Ignores
          headers.
        - Add table level static styles to control pseudo classes.
        ...
        uuid : str
            The underlying ``Styler`` uuid for static id.
        d : dict
...
def _parse_latex_table_styles(table_styles: CSSStyles, selector: str) -> str | None:
    ...
    Notes
    -----
    The replacement of "§" with ":" is to avoid the static problem where ":" has structural
...
def _parse_latex_cell_styles(
    ...
    If a static style is given as ('<command>', '<options>') this is translated to
...
def _parse_latex_css_conversion(styles: CSSList) -> CSSList:
    """
    Convert static (attribute,value) pairs to equivalent LaTeX (command,options) pairs.
    ...
    def color(value, user_arg, command, comm_arg):
        """
        static colors have 5 formats to process:
