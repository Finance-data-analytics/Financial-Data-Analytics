...
properties_args = """props : str, default None
           static properties to use for highlighting. If ``props`` is given, ``color``
           is not used."""
...
class Styler(StylerRenderer):
    r"""
    Helps style a DataFrame or Series according to the data with HTML and static.
    ...
    uuid : str, default None
        A unique identifier to avoid static collisions; generated automatically.
    ...
    return values with strings containing static ``'attr: value'`` that will
    ...
    static classes are attached to the generated HTML
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def set_tooltips(
        ...
        props : list-like or str, optional
            List of (attr, value) tuples or a valid static string. If ``None`` adopts
            the internal default values described in notes.
        css_class : str, optional
            Name of the tooltip class used in static, should conform to HTML standards.
            Only useful if integrating tooltips with external static. If ``None`` uses the
        ...
        and then manipulating the table level static to attach pseudo hover and pseudo
        after selectors to produce the required the results.

        The default properties for the tooltip static class are:
    ...
    def to_latex(
        ...
        *,
        ...
        convert_css : bool, default False
            Convert simple cell-styles from static to LaTeX format. Any static not found in
        ...
        **Cell Styles**
        ...
        functionality is built around the concept of a static ``(<attribute>, <value>)``
        ...
        For example the following code will highlight and bold a cell in HTML-static:
        ...
        **static Conversion**
        ...
        This method can convert a Styler constructured with HTML-static to LaTeX using
        the following limited conversions.

        ================== ==================== ============= ==========================
        static Attribute      static value            LaTeX Command LaTeX Options
        ================== ==================== ============= ==========================
        ...
        It is also possible to add user-defined LaTeX only styles to a HTML-static Styler
        using the ``--latex`` flag, and to add LaTeX parsing options that the
        converter will detect within a static-comment.
        ...
        Thirdly we will apply some (static-HTML) styles to our object. We will use a
        ...
        (from the {graphicx} package), that is not easy to convert from static and
    ...
    def to_html(
        ...
        **kwargs,
        ...
        """
        Write Styler to a file, buffer or string in HTML-static format.
        ...
        bold_headers : bool, optional
            Adds "font-weight: bold;" as a static property to table style header cells.
    ...
    def set_td_classes(self, classes: DataFrame) -> Styler:
        ...
        ----------
        classes : DataFrame
            DataFrame containing strings that will be translated to static classes,
        ...
        internal static solution without reference to external static files.
    ...
    def apply(
        ...
        **kwargs,
        ...
        """
        Apply a static-styling function column-wise, row-wise, or table-wise.
        ...
        **kwargs : dict
        ...
        See Also
        --------
        Styler.map_index: Apply a static-styling function to headers elementwise.
        Styler.apply_index: Apply a static-styling function to headers level-wise.
        Styler.map: Apply a static-styling function elementwise.

        Notes
        -----
        The elements of the output of ``func`` should be static styles as strings, in the
    ...
    @doc(
        ...
        output_note="an identically sized array of static styles as strings",
        var="s",
    ...
    def apply_index(
        ...
        **kwargs,
        ...
        """
        Apply a static-styling function to the index or column headers, {wise}.
        ...
        **kwargs : dict
        ...
        See Also
        --------
        Styler.{alt}_index: Apply a static-styling function to headers {altwise}.
        Styler.apply: Apply a static-styling function column-wise, row-wise, or table-wise.
        Styler.map: Apply a static-styling function elementwise.
    ...
    @doc(
        ...
        output_note="static styles as a string",
        var="v",
    ...
    def applymap_index(
        ...
        **kwargs,
        ...
        """
        Apply a static-styling function to the index or column headers, elementwise.
    ...
    def map(self, func: Callable, subset: Subset | None = None, **kwargs) -> Styler:
        """
        Apply a static-styling function elementwise.
    ...
    def export(self) -> dict[str, Any]:
        ...
        exported:
          ...
          - Any static classes added using ``Styler.set_td_classes``
    ...
    def use(self, styles: dict[str, Any]) -> Styler:
        ...
        styles : dict(str, Any)
            List of attributes to add to Styler. Dict keys should contain only:
              ...
              - "table_styles": static selectors and properties, typically added with
                ``set_table_styles``.
    ...
    def set_sticky(
        ...
        """
        Add static to permanently display the index or column headers in a scrolling frame.
        ...
        Notes
        -----
        This method uses the static 'position: sticky;' property to display. It is
        ...
        may produce strange behaviour due to static controls with missing elements.
        ...
        if not isinstance(obj, pd.MultiIndex):
            # handling MultiIndexes requires different static
    ...
    def set_table_styles(
        ...
        table_styles : list or dict
            ...
            should be a static selector that the style will be applied to
            ...
            `axis` argument. These will be mapped to row or col static
            selectors. MultiIndex values as dict keys should be
            in their respective tuple form. The dict values should be
            a list as specified in the form with static selectors and
        ...
        overwrite : bool, default True
            Styles are replaced if `True`, or extended if `False`. static
        ...
        css_class_names : dict, optional
            A dict of strings used to replace the default static classes described below.
        ...
        Notes
        -----
        The default static classes dict, whose values can be replaced is as follows:
    ...
    def set_properties(self, subset: Subset | None = None, **kwargs) -> Styler:
        """
        Set defined static-properties to each ``<td>`` HTML element for the given subset.
        ...
        **kwargs : dict
        ...
        function returning the static-properties independently of the data.
    ...
    def bar(  # pylint: disable=disallowed-name
        ...
        *,
        ...
        props : str, optional
            The base static of the cell that is extended to add the bar chart. Defaults to
            `"width: 10em;"`.
    ...
    def pipe(self, func: Callable, *args, **kwargs):
        ...
        **kwargs : optional
        ...
        Styler.apply : Apply a static-styling function column-wise, row-wise, or
            table-wise.
...
def _bar(
    ...
    """
    Draw bar chart in data cells using HTML static linear gradient.
    ...
    colors : list-like of str
        Two listed colors as string in valid static.
    width : float in [0,1]
    ...
    base_css : str
        Additional static that is included in the cell before bars are drawn.
    """

    def css_bar(start: float, end: float, color: str) -> str:
        """
        Generate static code to draw a bar from start to end in a table cell.
        ...
        color : str
            static valid color to apply.

        Returns
        -------
        str : The static applicable to the cell.
    ...
    def css_calc(x, left: float, right: float, align: str, color: str | list | tuple):
        """
        Return the correct static for bar placement based on calculated values.
        ...
        Returns
        -------
        str : Resultant static with linear gradient.
