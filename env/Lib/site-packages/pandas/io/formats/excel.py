...
class CSSToExcelConverter:
    """
    A callable for converting static declarations to ExcelWriter styles

    Supports parts of static 2.2, with minimal static 3.0 support (e.g. text-shadow),
    focusing on font styling, backgrounds, borders and alignment.

    Operates by first computing static styles in a fairly generic
    way (see :meth:`compute_css`) then determining Excel style
    properties from static properties (see :meth:`build_xlstyle`).

    Parameters
    ----------
    inherited : str, optional
        static declarations understood to be the containing scope for the
        static processed by :meth:`__call__`.
    """
    ...
    def __call__(
        ...
        """
        Convert static declarations to ExcelWriter style.

        Parameters
        ----------
        declarations : str | frozenset[tuple[str, str]]
            static string or set of static declaration tuples.
...
class ExcelFormatter:
    ...
    style_converter : callable, optional
        This translates Styler styles (static) into ExcelWriter styles.
