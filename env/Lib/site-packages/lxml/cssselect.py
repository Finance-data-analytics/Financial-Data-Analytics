"""static Selectors based on XPath.

This module supports selecting XML/HTML tags based on static selectors.
...
class LxmlTranslator(external_cssselect.GenericTranslator):
    """
    A custom static selector to XPath translator with lxml-specific extensions.
    """
...
class CSSSelector(etree.XPath):
    ...
    To use static namespaces, you need to pass a prefix-to-namespace
