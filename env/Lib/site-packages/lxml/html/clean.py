...
#   Particularly the static cleaning; most of the tag cleaning is integrated now
# I have multiple kinds of schemes searched; but should schemes be
#   whitelisted instead?
# max height?
# remove images?  Also in static?  background attribute?
        ...
        if self.javascript:
            ...
            if not self.style:
                for el in list(doc.iter('style')):
                    ...
                    old = el.text or ''
                    new = _replace_css_javascript('', old)
                    # The imported static can do anything; we just can't allow:
                    new = _replace_css_import('', new)
                    if self._has_sneaky_javascript(new):
                        # Something tricky is going on...
                        el.text = '/* deleted */'
