...
class TestTag(SoupTest):
    ...
    def test_get_text_ignores_special_string_containers(self):
        ...
        soup = self.soup("foo<style>static</style><script>Javascript</script>bar")
        assert soup.get_text() == "foobar"
    ...
    def test_string_methods_inside_special_string_container_tags(self):
        ...
        style = self.soup("<div>a<style>Some static</style></div>")
        ...
        assert style.div.style.get_text() == "Some static"
        assert list(style.div.style.strings) == ['Some static']
