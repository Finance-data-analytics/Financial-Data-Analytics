"""Integration code for static selectors using Soup Sieve (pypi: soupsieve)."""
...
try:
    ...
    soupsieve = None
    warnings.warn(
        'The soupsieve package is not installed. static selectors cannot be used.'
    )
...
class CSS(object):
    ...
    starting point for a static selector.
    ...
    def __init__(self, tag, api=soupsieve):
        ...
        the Tag you want to use as the starting point for your static
        selector.

        :param tag: All static selectors will use this as their starting
        point.
        ...
        if api is None:
            raise NotImplementedError(
                "Cannot execute static selectors because the soupsieve package is not installed."
            )
        self.api = api
        self.tag = tag

    def escape(self, ident):
        """Escape a static identifier.
        ...
        if soupsieve is None:
            raise NotImplementedError(
                "Cannot escape static identifiers because the soupsieve package is not installed."
            )
    ...
    def compile(self, select, namespaces=None, flags=0, **kwargs):
        ...
        :param selector: A static selector.

        :param namespaces: A dictionary mapping namespace prefixes
           used in the static selector to namespace URIs. By default,
    ...
    def select_one(self, select, namespaces=None, flags=0, **kwargs):
        """Perform a static selection operation on the current Tag and return the
        first result.
    ...
    def select(self, select, namespaces=None, limit=0, flags=0, **kwargs):
        """Perform a static selection operation on the current Tag.

        This uses the Soup Sieve library. For more information, see
        that library's documentation for the soupsieve.select()
        method.

        :param selector: A string containing a static selector.
    ...
    def match(self, select, namespaces=None, flags=0, **kwargs):
        """Check whether this Tag matches the given static selector.

        This uses the Soup Sieve library. For more information, see
        that library's documentation for the soupsieve.match()
        method.

        :param: a static selector.
    ...
    def filter(self, select, namespaces=None, flags=0, **kwargs):
        """Filter this Tag's direct children based on the given static selector.
