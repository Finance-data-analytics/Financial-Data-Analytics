...
class Tag(PageElement):
    ...
    # static selector code
    def select_one(self, selector, namespaces=None, **kwargs):
        """Perform a static selection operation on the current element.
    ...
    @property
    def css(self):
        """Return an interface to the static selector API."""
        return CSS(self)
