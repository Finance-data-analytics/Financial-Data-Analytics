...
def scroll_into_view_if_needed(
    ...
    **EXPERIMENTAL**
    ...
    :param backend_node_id: *(Optional)* Identifier of the backend node.
    :param object_id: *(Optional)* JavaScript object id of the node wrapper.
    :param rect: *(Optional)* The rect to be scrolled into view, relative to the node's border box, in static pixels. When omitted, center of the node will be used, similar to Element.scrollIntoView.
    '''
    params: T_JSON_DICT = dict()
    if node_id is not None:
        params['nodeId'] = node_id.to_json()
...
class InlineStyleInvalidated:
    ...
    **EXPERIMENTAL**
    ...
    Fired when ``Element``'s inline style is modified via a static property modification.
    '''
