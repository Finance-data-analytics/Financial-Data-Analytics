...
@dataclass
class TouchPoint:
    #: X coordinate of the event relative to the main frame's viewport in static pixels.
    x: float

    #: Y coordinate of the event relative to the main frame's viewport in static pixels. 0 refers to
...
def dispatch_mouse_event(
    ...
    :param x: X coordinate of the event relative to the main frame's viewport in static pixels.
    :param y: Y coordinate of the event relative to the main frame's viewport in static pixels. 0 refers to the top of the viewport and Y increases as it proceeds towards the bottom of the viewport.
    :param modifiers: *(Optional)* Bit field representing pressed modifier keys. Alt=1, Ctrl=2, Meta/Command=4, Shift=8 (default: 0).
    :param timestamp: *(Optional)* Time at which the event occurred.
    ...
    :param delta_x: *(Optional)* X delta in static pixels for mouse wheel event (default: 0).
    :param delta_y: *(Optional)* Y delta in static pixels for mouse wheel event (default: 0).
...
def synthesize_pinch_gesture(
    ...
    **EXPERIMENTAL**
    ...
    :param x: X coordinate of the start of the gesture in static pixels.
    :param y: Y coordinate of the start of the gesture in static pixels.
