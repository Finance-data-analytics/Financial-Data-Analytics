...
#
# CDP domain: static (experimental)
...
class PseudoElementMatches:
    '''
    static rule collection for a single pseudo style.
    '''
    #: Pseudo element type.
    pseudo_type: dom.PseudoType

    #: Matches of static rules applicable to the pseudo style.
...
class InheritedStyleEntry:
    '''
    Inherited static rule collection from ancestor node.
    '''
    #: Matches of static rules matching the ancestor node in the style inheritance chain.
...
class RuleMatch:
    '''
    Match data for a static rule.
    '''
    #: static rule in the match.
    rule: CSSRule
...
class CSSStyleSheetHeader:
    '''
    static stylesheet metainformation.
    '''
...
class CSSRuleType(enum.Enum):
    '''
    Enum indicating the type of a static rule, used to represent the order of a style rule's ancestors.
...
class CSSStyle:
    '''
    static style representation.
    '''
    #: static properties in the style.
...
class CSSProperty:
    '''
    static property declaration data.
    '''
    #: The property name.
    name: str
...
class CSSContainerQuery:
    '''
    static container query rule descriptor.
    '''
...
class CSSSupports:
    '''
    static Supports at-rule descriptor.
    '''
    #: Supports rule text.
    text: str
...
class CSSScope:
    '''
    static Scope at-rule descriptor.
    '''
    #: Scope rule text.
    text: str
...
class CSSLayer:
    '''
    static Layer at-rule descriptor.
    '''
    #: Layer name.
    text: str
...
class CSSTryRule:
    '''
    static try rule representation.
    '''
    #: Parent stylesheet's origin.
    origin: StyleSheetOrigin
...
class CSSPositionFallbackRule:
    '''
    static position-fallback rule representation.
    '''
    name: Value
...
class CSSKeyframesRule:
    '''
    static keyframes rule representation.
    '''
    #: Animation name.
...
class CSSPropertyRegistration:
    '''
    Representation of a custom property registration through static.registerProperty
    '''
    property_name: str
...
class CSSPropertyRule:
    '''
    static property at-rule representation.
    '''
    #: Parent stylesheet's origin.
    origin: StyleSheetOrigin
...
class CSSKeyframeRule:
    '''
    static keyframe rule representation.
    '''
    #: Parent stylesheet's origin.
    origin: StyleSheetOrigin
...
def collect_class_names(
    ...
    params['styleSheetId'] = style_sheet_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.collectClassNames',
        'params': params,
    }
    json = yield cmd_dict
...
def create_style_sheet(
    ...
    cmd_dict: T_JSON_DICT = {
        'method': 'static.createStyleSheet',
        'params': params,
    }
    json = yield cmd_dict
...
def disable() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    '''
    Disables the static agent for the given page.
    '''
    cmd_dict: T_JSON_DICT = {
...
def enable() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    '''
    Enables the static agent for the given page. Clients should not assume that the static agent has been
...
def force_pseudo_state(
    ...
    cmd_dict: T_JSON_DICT = {
        'method': 'static.forcePseudoState',
        'params': params,
    }
    json = yield cmd_dict
...
def get_background_colors(
    ...
    :returns: A tuple with the following items:
        ...
        1. **computedFontSize** - *(Optional)* The computed font size for this node, as a static computed value string (e.g. '12px').
        2. **computedFontWeight** - *(Optional)* The computed font weight for this node, as a static computed value string (e.g. 'normal' or '100').
    '''
    params: T_JSON_DICT = dict()
    params['nodeId'] = node_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.getBackgroundColors',
        'params': params,
    }
    json = yield cmd_dict
    return (
...
def get_computed_style_for_node(
    ...
    params['nodeId'] = node_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.getComputedStyleForNode',
        'params': params,
    }
    json = yield cmd_dict
...
def get_inline_styles_for_node(
    ...
    params['nodeId'] = node_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.getInlineStylesForNode',
        'params': params,
    }
    json = yield cmd_dict
    return (
...
def get_matched_styles_for_node(
    ...
    :returns: A tuple with the following items:
        ...
        0. **inlineStyle** - *(Optional)* Inline style for the specified DOM node.
        1. **attributesStyle** - *(Optional)* Attribute-defined element style (e.g. resulting from "width=20 height=100%").
        2. **matchedCSSRules** - *(Optional)* static rules matching this node, from all applicable stylesheets.
        ...
        6. **cssKeyframesRules** - *(Optional)* A list of static keyframed animations matching this node.
        7. **cssPositionFallbackRules** - *(Optional)* A list of static position fallbacks matching this node.
        8. **cssPropertyRules** - *(Optional)* A list of static at-property rules matching this node.
        9. **cssPropertyRegistrations** - *(Optional)* A list of static property registrations matching this node.
        10. **parentLayoutNodeId** - *(Optional)* Id of the first parent element that does not have display: contents.
    '''
    params: T_JSON_DICT = dict()
    params['nodeId'] = node_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.getMatchedStylesForNode',
        'params': params,
    }
    json = yield cmd_dict
    return (
...
def get_platform_fonts_for_node(
    ...
    params['nodeId'] = node_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.getPlatformFontsForNode',
        'params': params,
    }
    json = yield cmd_dict
...
def get_style_sheet_text(
    ...
    params['styleSheetId'] = style_sheet_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.getStyleSheetText',
        'params': params,
    }
    json = yield cmd_dict
...
def get_layers_for_node(
    ...
    **EXPERIMENTAL**
    ...
    params['nodeId'] = node_id.to_json()
    cmd_dict: T_JSON_DICT = {
        'method': 'static.getLayersForNode',
        'params': params,
    }
    json = yield cmd_dict
...
def track_computed_style_updates(
    ...
    **EXPERIMENTAL**
    ...
    cmd_dict: T_JSON_DICT = {
        'method': 'static.trackComputedStyleUpdates',
        'params': params,
    }
    json = yield cmd_dict
...
def take_computed_style_updates() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,typing.List[dom.NodeId]]:
    ...
    **EXPERIMENTAL**
    ...
    '''
    cmd_dict: T_JSON_DICT = {
        'method': 'static.takeComputedStyleUpdates',
    }
    json = yield cmd_dict
...
def set_effective_property_value_for_node(
    ...
    params['value'] = value
    cmd_dict: T_JSON_DICT = {
        'method': 'static.setEffectivePropertyValueForNode',
        'params': params,
    }
    json = yield cmd_dict
...
def set_property_rule_property_name(
    ...
    params['propertyName'] = property_name
    cmd_dict: T_JSON_DICT = {
        'method': 'static.setPropertyRulePropertyName',
        'params': params,
    }
    json = yield cmd_dict
...
def set_media_text(
    ...
    :param range_:
    :param text:
    :returns: The resulting static media rule after modification.
    '''
    params: T_JSON_DICT = dict()
    params['styleSheetId'] = style_sheet_id.to_json()
    params['range'] = range_.to_json()
...
def set_container_query_text(
    ...
    **EXPERIMENTAL**
    ...
    :param range_:
    :param text:
    :returns: The resulting static container query rule after modification.
    '''
    params: T_JSON_DICT = dict()
    params['styleSheetId'] = style_sheet_id.to_json()
    params['range'] = range_.to_json()
    params['text'] = text
    cmd_dict: T_JSON_DICT = {
        'method': 'static.setContainerQueryText',
        'params': params,
    }
    json = yield cmd_dict
...
def set_supports_text(
    ...
    **EXPERIMENTAL**
    ...
    :param range_:
    :param text:
    :returns: The resulting static Supports rule after modification.
    '''
    params: T_JSON_DICT = dict()
    params['styleSheetId'] = style_sheet_id.to_json()
    params['range'] = range_.to_json()
...
def set_scope_text(
    ...
    **EXPERIMENTAL**
    ...
    :param range_:
    :param text:
    :returns: The resulting static Scope rule after modification.
    '''
    params: T_JSON_DICT = dict()
    params['styleSheetId'] = style_sheet_id.to_json()
    params['range'] = range_.to_json()
...
def set_style_sheet_text(
    ...
    params['text'] = text
    cmd_dict: T_JSON_DICT = {
        'method': 'static.setStyleSheetText',
        'params': params,
    }
    json = yield cmd_dict
...
def start_rule_usage_tracking() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    ...
    '''
    cmd_dict: T_JSON_DICT = {
        'method': 'static.startRuleUsageTracking',
    }
    json = yield cmd_dict
...
def stop_rule_usage_tracking() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,typing.List[RuleUsage]]:
    ...
    '''
    cmd_dict: T_JSON_DICT = {
        'method': 'static.stopRuleUsageTracking',
    }
    json = yield cmd_dict
...
def take_coverage_delta() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,typing.Tuple[typing.List[RuleUsage], float]]:
    ...
    '''
    cmd_dict: T_JSON_DICT = {
        'method': 'static.takeCoverageDelta',
    }
    json = yield cmd_dict
    return (
...
def set_local_fonts_enabled(
    ...
    '''
    Enables/disables rendering of local static fonts (enabled by default).
    ...
    **EXPERIMENTAL**
    ...
    cmd_dict: T_JSON_DICT = {
        'method': 'static.setLocalFontsEnabled',
        'params': params,
    }
    json = yield cmd_dict


@event_class('static.fontsUpdated')
@dataclass
class FontsUpdated:
    '''
...
@event_class('static.mediaQueryResultChanged')
@dataclass
...
@event_class('static.styleSheetAdded')
@dataclass
...
@event_class('static.styleSheetChanged')
@dataclass
...
@event_class('static.styleSheetRemoved')
@dataclass
